...
require "logstash-forwarder/util/password"
...
#
# class Foo < LogStashForwarder::Config
...
# }
#
module LogStashForwarder::Config::Mixin
  ...
  # This method is called when someone does 'include LogStashForwarder::Config'
  def self.included(base)
    # Add the DSL methods to the 'base' given.
    base.extend(LogStashForwarder::Config::Mixin::DSL)
  end
    ...
    self.class.get_config.each do |name, opts|
      ...
      if opts.include?(:default) and (name.is_a?(Symbol) or name.is_a?(String))
        if opts[:validate] == :password
          ...
          params[name.to_s] = ::LogStashForwarder::Util::Password.new(opts[:default])
        else
  ...
  module DSL
    ...
    def config_name(name=nil)
      ...
      LogStashForwarder::Config::Registry.registry[@config_name] = self
      return @config_name
    end
    ...
    def validate(params)
      ...
      @logger = LogStashForwarder::Logger.new(STDOUT)
      is_valid = true
    ...
    def validate_value(value, validator)
      ...
      # (see LogStashForwarder::Inputs::File for example)
      result = nil
      ...
      if validator.nil?
        ...
        case validator
          ...
          when :password
            ...
            result = ::LogStashForwarder::Util::Password.new(value.first)
        end # case validator
      else
  ...
  end # module LogStashForwarder::Config::DSL
end # module LogStashForwarder::Config
