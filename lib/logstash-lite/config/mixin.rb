...
require "logstash-lite/config/registry"
require "logstash-lite/logging"
require "logstash-lite/util/password"
...
# }
#
module LogStashLite::Config::Mixin
  ...
  # This method is called when someone does 'include LogStashLite::Config'
  def self.included(base)
    # Add the DSL methods to the 'base' given.
    base.extend(LogStashLite::Config::Mixin::DSL)
  end
    ...
    self.class.get_config.each do |name, opts|
      ...
      if opts.include?(:default) and (name.is_a?(Symbol) or name.is_a?(String))
        if opts[:validate] == :password
          ...
          params[name.to_s] = ::LogStashLite::Util::Password.new(opts[:default])
        else
  ...
  module DSL
    ...
    def config_name(name=nil)
      ...
      LogStashLite::Config::Registry.registry[@config_name] = self
      return @config_name
    end
    ...
    def validate(params)
      ...
      @logger = LogStashLite::Logger.new(STDOUT)
      is_valid = true
    ...
    def validate_value(value, validator)
      ...
      # (see LogStashLite::Inputs::File for example)
      result = nil
      ...
      if validator.nil?
        ...
        case validator
          ...
          when :password
            ...
            result = ::LogStashLite::Util::Password.new(value.first)
        end # case validator
      else
  ...
  end # module LogStashLite::Config::DSL
end # module LogStashLite::Config
